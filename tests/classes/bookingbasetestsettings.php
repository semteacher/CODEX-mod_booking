...
class bookingbasetestsettings {
    ...
    /**
     * Set booking instance data overrides.
     *
    ...
    /**
     * Set booking option data overrides.
     *
    ...
    /**
     * Set teacher role name.
     *
     * @param string $teacherrole
     * @return void
     */
    public function set_teacher_role(string $teacherrole): void {
     ...
     * @return void
     */
    public function set_student_role(string $studentrole): void {
